...
public class CoachAnalysisActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String gender = getIntent().getStringExtra(CoachShowBodyDetailActivity.GENDER);
        int age = ShowAllUserActivity.getAGE();
        String ageS = Integer.toString(age);
        double fatPercent = CoachShowAllBodyActivity.getFatPercent();
        String fatPercentS = Double.toString(fatPercent);
        double visceralFat = CoachShowAllBodyActivity.getVisceralFat();
        String visceralFatS = Double.toString(visceralFat);


        ageV.setText(ageS);
        genderV.setText(gender);

        visceralV.setText(visceralFatS);
        fatpercentV.setText(fatPercentS);
    ...
    public boolean onNavigationItemSelected(MenuItem item){
        ...
        switch (id)
        {
            case R.id.nav_account:
                startActivity(new Intent(CoachAnalysisActivity.this, MainActivity.class));
                finish();
                break;

            case R.id.nav_me:
                startActivity(new Intent(CoachAnalysisActivity.this, ShowPersonalActivity.class));
                finish();
                break;

            case R.id.nav_calFat:
                startActivity(new Intent(CoachAnalysisActivity.this, CalculateFatActivity.class));
                finish();
                break;

            case R.id.nav_showAllUser:
                startActivity(new Intent(CoachAnalysisActivity.this, ShowAllUserActivity.class));
                finish();
                break;

            case R.id.nav_bodyComposition:
                startActivity(new Intent(CoachAnalysisActivity.this, ShowAllBodyActivity.class));
                finish();
                break;

            case R.id.nav_activityBoard:
                startActivity(new Intent(CoachAnalysisActivity.this, ActivityBoardActivity.class));
                finish();
                break;

            case R.id.nav_diet:
                startActivity(new Intent(CoachAnalysisActivity.this, DietDiaryActivity.class));
                finish();
                break;

            case R.id.nav_customerLog:
                startActivity(new Intent(CoachAnalysisActivity.this, ShowAllLogActivity.class));
                finish();
                break;
